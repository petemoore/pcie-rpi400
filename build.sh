...
aarch64-none-elf-objcopy --set-start=0x80000 pcie-rpi400.elf -O binary dist/pcie-rpi400.img
aarch64-none-elf-objdump -b binary -z --adjust-vma=0x80000 -maarch64 -D dist/pcie-rpi400.img
